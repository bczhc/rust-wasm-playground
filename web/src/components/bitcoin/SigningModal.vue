...
let sigHashOptions: { label: string, value: SigHashKey, code: number }[] = [
  {label: 'All', value: 'All', code: 0x01},
  {label: 'None', value: 'None', code: 0x02},
  {label: 'Single', value: 'Single', code: 0x03},
  {label: 'All+AnyoneCanPay', value: 'AllPlusAnyoneCanPay', code: 0x81},
  {label: 'None+AnyoneCanPay', value: 'NonePlusAnyoneCanPay', code: 0x82},
  {label: 'Single+AnyoneCanPay', value: 'SinglePlusAnyoneCanPay', code: 0x83},
];
...
<template>
  ...
  >
    <n-card
        style="width: 600px"
        :title="`Signing for TxIn #${props.index}`"
        :bordered="false"
        size="huge"
        role="dialog"
        aria-modal="true"
